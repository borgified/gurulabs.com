...
# Creation of the RPM:
#  cd ~/RPMBUILD/SOURCES
#  tar cvzf vlt2010-cpl-0.1.i386.tar.gz -C / vlt/VLT2010/cpl
#  cd ~/RPMBUILD/SPECS
#  rpmbuild -bb vlt2010-cpl.i386.spec
#
# Installation of the RPM
# As root:
#  mv /vlt/VLT2010/cpl /vlt/VLT2010/cpl.old
#  rpm -ihv /home/vltmgr/RPMBUILD/RPMS/i386/vlt2010-cpl-0.1-1.i386.rpm

Name: vlt2010-cpl
Summary: VLT2010 cpl binary
Version: 0.1
Release: 5
...
VLT2010: cpl
Compiled on SL53
vlt2010-cpl generated on 2010-02-05
%prep
...
%changelog
* Wed Jul 28 2009 VLT2010 CPL Beta 0.1
