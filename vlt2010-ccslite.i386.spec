...
# Creation of the RPM:
#  cd ~/RPMBUILD/SOURCES
#  tar cvzf vlt2010-ccslite-0.1.i386.tar.gz -C / vlt/VLT2010/CCSLite
#  cd ~/RPMBUILD/SPECS
#  rpmbuild -bb vlt2010-ccslite.i386.spec
#
# Installation of the RPM
# As root:
#  mv /vlt/VLT2010/CCSLite /vlt/VLT2010/CCSLite.old
#  rpm -ihv /home/vltmgr/RPMBUILD/RPMS/i386/vlt2010-ccslite-0.1-1.i386.rpm

Name: vlt2010-ccslite
Summary: VLT2010 CCSLite binary
Version: 0.1
Release: 47
...
VLT2010: CCSLite 
Compiled on SL53
vlt2010-ccslite generated on 2010-06-10
...
%defattr (4755, root, vlt)
/vlt/VLT2010/CCSLite/bin/msgServer1
/vlt/VLT2010/CCSLite/bin/ccsScheduler1
/vlt/VLT2010/CCSLite/bin/vccmake1
