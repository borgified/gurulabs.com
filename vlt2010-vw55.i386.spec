...
# Creation of the RPM:
#  cd ~/RPMBUILD/SOURCES
#  tar cvzf vlt2010-vw55-0.1.i386.tar.gz -C / vlt/VLT2010/vw5.5
#  cd ~/RPMBUILD/SPECS
#  rpmbuild -bb vlt2010-vw55.i386.spec
#
# Installation of the RPM
# As root:
#  mv /vlt/VLT2010/vw5.5 /vlt/VLT2010/vw5.5.old
#  rpm -ihv /home/vltmgr/RPMBUILD/RPMS/i386/vlt2010-vw55-0.1-1.i386.rpm

Name: vlt2010-vw55
Summary: VLT2010 vw5.5 binary
Version: 0.1
Release: 7
...
VLT2010: vw5.5
Compiled on SL53
vlt2010-vw55 generated on 2009-10-29

%changelog
* Wed Jul 28 2009 VLT2010 wv55 Beta 0.1
